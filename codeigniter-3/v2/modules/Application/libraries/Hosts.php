 ...
 *
 * Example:
 * $this->load->library('application/hosts');
 * $this->hosts->add_host( 'main', array( 'domain' => 'mydomain.com', 'path' => 'assets' ) );
 * $this->hosts->add_host( 'cdn', array( 'domain' => 'cdn.mydomain.com', 'path' => '' ) );
 * $this->hosts->add_host( 'server1', array( 'domain' => 'a.mydomain.com', 'path' => '' ) );
 * $this->hosts->add_host( 'server2', array( 'domain' => 'b.mydomain.com', 'path' => '' ) );
 * $this->hosts->add_host( 'server3', array( 'domain' => 'c.mydomain.com', 'path' => '' ) );
 * echo "<img src='{$this->hosts->get_url( 'logo.png' )}' />";
 * echo "<img src='{$this->hosts->get_url( 'logo.png', 'main' )}' />";
 * echo "<img src='{$this->hosts->get_url( 'sprites.png', 'cdn' )}' />";
 * echo "<img src='{$this->hosts->get_url( 'sprites.png', false, true )}' />";
 *
 */
class Hosts {
